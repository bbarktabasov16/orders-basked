...
const renderOrderItem = (orderItem) => {
  return `
    <li class="order-item">
      ...
      <div class="order-item_count">Количество : <span>${orderItem.count}</span></div>
      <div class="order-item_price">Сумма : <span>${orderItem.price} сом</span></div>
      <div class="order-item_delete">
        <img data-order='${JSON.stringify(orderItem)}' onclick="onDelete()" src="./img/free-icon-delete-4974628.png">
      </div>
    </li>
  `
}
